...
root = Tk()
root.title("Naukri.com Search Result")
...
label_0 =Label(root, text="Enter basis of comparision:")
label_compare = Label(image=compare_logo)
label_0.config(font=(40))


search_bar = Entry(root, width=50, borderwidth=3, font=(18))
...
def on_click():
    ...
    if flag and anchors.find('h3'):
        ...
        f=1;
        link_btn = Button(root, text="Go to page", command=open_link,bg="#dddddd", borderwidth=2)
        link_btn.config(font=(14))
        link_btn.grid(column=0, row=8, pady=10, padx=40)
    
        link_btn2 = Button(root, text="Go to page", command=open_link,bg="#dddddd", borderwidth=2)
    ...
    my_button = Button(root, text="Comapare", command=label_del, bg='#dddddd', borderwidth=2)  
...
my_button = Button(root, text="Comapare", command=on_click, bg='#dddddd', borderwidth=2)  
my_button.config(font=(15)) 
my_button.grid(column=1, row=3, pady=20,padx=40)
